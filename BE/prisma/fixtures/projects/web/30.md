---
title: web30-TADAK
description: 혼자 풀던 알고리즘, 이제는 실시간 배틀로 ⚔️
teamName: TADAK
participants: ['dyeon-dev', 'cchaeyoung', 'SubJeeLee', 'eeekeee']
---
...
**CodeRena**는 혼자서 외롭게 풀던 알고리즘 문제 풀이를 **실시간 경쟁 게임**으로 재해석한 웹 서비스입니다.

- **개발 기간:** 2025.12.08 ~ 2026.02.06 (2주 MVP / N주 고도화)
- **배포 주소:**
