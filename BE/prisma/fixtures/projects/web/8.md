---
title: web08-JAMstack
description: 로그인 없이 바로 시작하는 실시간 협업 코드 에디터, CodeJam
teamName: JAMstack
demoUrl: http://49.50.138.93/
thumbnailUrl: https://github.com/boostcampwm2025/web08-JAMstack/raw/dev/docs/assets/slogan_animation.svg
participants: ['kindsmell', 'Happysttim', 'inaemin', 'son-hyejun', 'lnxhigh']
---
