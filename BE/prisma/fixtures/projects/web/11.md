---
title: web11-MMH
description: 머릿속의 토막 지식을 말로 풀어내며 스스로 부족함을 찾고, 흩어진 지식을 하나로 연결 하세요! 🌎
teamName: 말만해
participants: ['AYEOOON', 'kimjihyo', 'dltnwjd308', 'rwaeng', 'swgivenchy']
---
...
- [말만해](#말만해)
  ...
  - [소개](#소개)
    - [프로젝트 소개](#프로젝트-소개)
    - [프로젝트 주요 가치](#프로젝트-주요-가치)
    - [프로젝트 개발 목적과 목표](#프로젝트-개발-목적과-목표)
    - [프로젝트 관련 링크](#프로젝트-관련-링크)
  - [기술 스택](#기술-스택)
    - [common](#common)
    - [FE](#fe)
    - [BE](#be)
    - [Infra Structure \& AI](#infra-structure--ai)
  - [요구 사항](#요구-사항)
  - [시작하기](#시작하기)
